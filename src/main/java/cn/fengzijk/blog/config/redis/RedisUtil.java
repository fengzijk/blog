...
package cn.fengzijk.blog.config.redis;
...
public class RedisUtil {
    ...
    /**
     * 获取 key 下的 所有keys集合的value
     *
     * @param key
     * @return
     */
    public List<Object> getMultiGet(String key, Collection keys) {
    ...
    public Set<Object> difference(String key, Collection<Object> otherKeys) {
        return redisTemplate.opsForSet().difference(key, String.valueOf(otherKeys));
    }
    ...
    public Long differenceAndStore(String key, Collection<Object> otherKeys, String newKey) {
        return redisTemplate.opsForSet().differenceAndStore(newKey, String.valueOf(otherKeys), newKey);
    }
    ...
    public Set<Object> unionSet(String key, Collection<Object> otherKeys) {
        return redisTemplate.opsForSet().union(key, String.valueOf(otherKeys));
    }
    ...
    public Long unionAndStoreSet(String key, Collection<Object> otherKeys, String destKey) {
        return redisTemplate.opsForSet().unionAndStore(key, String.valueOf(otherKeys), destKey);
    }
